...
- [x] **Transaction Idempotency Guard:** Update execute_transfer to check this table inside the existing SQL transaction. If the key exists, return the cached result.
